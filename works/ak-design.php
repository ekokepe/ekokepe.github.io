...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Lato|Kalam" rel="stylesheet"/>
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.7.2/css/all.css" integrity="sha384-fnmOCqbTlWIlj8LyTjo7mOUStjsKC4pOpQbqyi7RrhN7udi9RwhKkMHpvLbHG9Sr" crossorigin="anonymous">
    <title>Graphic Design Internship | Eko Khoirunnas Priyadi</title>
</head>
<body>
    <?php //Tambahkan Header
        global $hdindex;
    ...
    ?>
    <div id="body">
        <h2>Graphic Design Internship at Indolecture AngklungKita</h2>
        ...
        <div id="intro">
            <div id="ph_main">
                ...
                <div id="photo1">
                    <img class="ph1_pic" src="wk_ak-design/main1.jpg">
                    <div class="ph1_desc"><p>T-shirt design</p></div>
                    <img class="ph1_pic" src="wk_ak-design/main2.jpg">
                    <div class="ph1_desc"><p>Namecard design</p></div>
                    <img class="ph1_pic" src="wk_ak-design/main3.jpg">
                    <div class="ph1_desc"><p>Leaflet design</p></div>
                    <img class="ph1_pic" src="wk_ak-design/main4.jpg">
                    <div class="ph1_desc"><p>Scouts' Day poster for Instagram publication</p></div>
                    <img class="ph1_pic" src="wk_ak-design/main5.jpg">
                    <div class="ph1_desc"><p>Publication design guidelines</p></div>
                </div>
            ...
            <div id="desc">
                ...
                <div id="d_desc">
                    <ul>
                        <li>Making publication design guideline</li>
                        ...
                        <li>Contacting and ordering product from printing houses</li>
                        <li>Designing promotional posters for social media</li>
        ...
        <div id="desc2">
            <div>
                <h3>Features</h3>
                <p>Mock-up as a display property of the final products</p>
            </div>
            <div>
                <h3>Benefit</h3>
                <p>Promotional media, increasing brand awareness of Indolecture AngklungKita</p>
            </div>
            <div>
